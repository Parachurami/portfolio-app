...
const ExperienceCard = ({jobTitle, companyName, startMonth, endMonth}:ExperienceCardProp) => {
  return (
    <View className='w-full flex flex-row p-3 rounded-2xl shadow-black shadow bg-white justify-between items-center'>
        <View className='h-full flex flex-row' style={{gap:15}}>
            ...
            <View className='flex flex-col p-0 m-0'>
                <Text className='text-[24px] font-extrabold'>{jobTitle}</Text>
